...
ArrayList<FichaAtendimento> lista	= controller.listarSeparada(nomeBusca, tipoBusca);
  ...
  <nav class="navbar navbar-expand-md navbar-light" style="background-color: #e3f2fd;">
    ...
    <div class="container-fluid">
        ...
        <form class="d-flex ms-5">
            <button class="btn btn-success" formaction="./listar.cliente.jsp">Gerente</button>
        </form>
...
<div class="container80">
    <div class="conform">
        ...
        <form action="listar.consulta.jsp" class="searchbar" method="get">
            <input type="text" class="search__input float-left" name="buscar" autofocus>
            <button type="submit" class="btn-search"><i class="fa-solid fa-magnifying-glass"></i></button>
            <div class="box-check float-left">
                <div>
                    <input type="radio" id="macho" name="tipoBusca" value="1">
                    <label class="m">Nome Animal</label>

                    <input type="radio" id="femea" name="tipoBusca" value="2">
                    <label class="f">Nome Dono</label>
