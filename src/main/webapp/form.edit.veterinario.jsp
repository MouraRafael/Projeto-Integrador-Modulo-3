...
%>
<%
   long idVet = Long.parseLong(request.getParameter("idvet"));
...
<div class="container80">
 <div class="conform">
    ...
    <form class="row g-3" action="../VeterinarioCadastroServlet" method="post">
        <div class="col-md-12">
            <label for="cliente" class="label">Nome:</label>
            <input type="text" class="form-control" id="nome" name="nome_vet" placeholder="Digite Seu Nome">        
        </div>
        <div class="col-md-6">
            <label for="cpf" class="label">CPF:</label>
            <input type="number" min="0" max="99999999999" class="form-control" id="cpf" name="cpf" placeholder="000.000.000-00">
        </div>
        <div class="col-md-6">
            <label for="crmv" class="label">CRMV:</label>
            <input type="number" min="0" max="99999" class="form-control" id="crmv" name="crmv" placeholder="00000">
        </div>
        ...
        <div class="col-md-6">
            ...
            <input type="number" min="0" max="99999999" class="form-control" id="cep" name="cep" placeholder="00000-000">
        </div>
        <div class="col-md-6">
            <label for="numero" class="label">Número</label>
            <input type="number" min="0" class="form-control" id="numero" name="numero" placeholder="Nº">
        </div>


        <div class="col-12">
            <button type="submit" class="btn btn-primary">Cadastrar Veterinario</button>
