                        ...
                        <form action="redirect.animal.cadastro2.php" method="post">
                            <div class="form-container">
                                ...
                                <div class="box">
                                    ...
                                    <div class="ipt">
                                        <label for="raca_animal" class="label">Ra�a:</label>
                                        <select name="raca_animal" id="select" autofocus>
                                            <option value="" selected disabled>Selecione a Ra�a</option>
                                            <option value=""></option>
                                        </select>
                                    </div>
                                </div>
                                <button type="submit" class="cad-animal btn" name="btn_id_dono" value="">Cadastrar Animal</button>
                            </div>
                        </form>
                    </div>
                </div>
